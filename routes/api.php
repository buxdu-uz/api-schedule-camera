...
//public
    ...
    Route::get('/schedule/currentDay',[ScheduleListController::class,'getDailySchedule']);
    Route::get('/schedule/room/list',[ScheduleListController::class,'getWeeklySchedule']);
